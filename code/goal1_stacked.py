"""
Task 1: Two 3-block towers - STACKED SCENARIO
...
while iteration < max_iterations:
    ...
    problem_string = generate_pddl_problem(current_predicates,goal_predicates,blocks,f"goal1_stacked_iter{iteration}")
